...
const FeedCard: React.FC<FeedCardProps> = (props) => {
    const { data } = props
    return <div className='border border-r-0 border-l-0 border-b-0 border-gray-600 p-4 hover:bg-slate-900 transition-all cursor-pointer'>
        <div className='grid grid-cols-12 gap-3'>
            ...
            <div className='col-span-11'>
                ...
                <div className='flex items-center justify-between mt-5 text-xl p-2 w-[90%]'>
                    <div>
                        <BiMessageRounded />
                    </div>
                    <div>
