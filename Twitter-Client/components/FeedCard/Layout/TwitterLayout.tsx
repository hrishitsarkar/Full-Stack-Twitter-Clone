    ...
    return (
      <div>
        <div className="grid grid-cols-12 h-screen w-screen sm:px-56">
            ...
            <div>
              ...
              <div className="mt-1 text-xl pr-4">
                ...
                <div className="mt-5 px-3">
                  ...
                  <button className="sm:hidden block bg-[#1d9bf0] font-semibold text-lg py-2 px-3 rounded-full w-full">
                    <BsTwitter />
                  </button>
                </div>
              </div>
          ...
          <div className="col-span-10 sm:col-span-5 border-r-[1px] border-l-[1px] h-screen overflow-scroll scrollbar-hide  border-gray-600">
            {props.children}
          </div>
          <div className="col-span-0 sm:col-span-3 p-5 ">
            {!user ? (
              ...
              <div className="px-4 py-3 w-full bg-slate-800 rounded-lg">
